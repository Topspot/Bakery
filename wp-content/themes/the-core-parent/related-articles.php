<?php
$the_core_enable_related_articles  = defined( 'FW' ) ? fw_get_db_settings_option( 'posts_settings/related_articles', '' ) : '';
				...
				<?php foreach ( $the_core_related_articles as $item ) :
					...
					<li>
						<div class="fw-related-article-image fw-block-image-parent fw-overlay-2">
							<a href="<?php echo esc_url( get_permalink( $item->ID ) ); ?>" class="fw-block-image-child <?php echo esc_attr($ratio_class); ?>">
								<?php if ( $image ) {
									echo $image['img'];
								} else { ?>
