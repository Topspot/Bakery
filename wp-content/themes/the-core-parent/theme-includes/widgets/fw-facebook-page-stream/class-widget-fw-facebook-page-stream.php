...
if ( defined( 'FW' ) && function_exists( 'fw_ext_social_facebook_graph_api_explorer' ) ) {
	...
	class Widget_Fw_Facebook_Page_Stream extends WP_Widget {
		...
		function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php esc_html_e( 'Page Link:', 'the-core' ); ?> </label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of Posts:', 'the-core' ); ?></label>
	...
	class Widget_Fw_Facebook_Page_Stream {
		public $id_base = '';
