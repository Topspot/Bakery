...
if ( defined( 'FW' ) && function_exists( 'fw_ext_social_twitter_get_connection' ) && function_exists( 'curl_exec' ) ) {
	...
	class Widget_Fw_Twitter extends WP_Widget {
		...
		function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'user' ) ); ?>"><?php esc_html_e( 'User:', 'the-core' ); ?> </label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of Tweets:', 'the-core' ); ?></label>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'display_logo' ) ); ?>"><?php esc_html_e( 'Display Logo?', 'the-core' ); ?></label>
			</p>
			<p>
