...
if ( ! function_exists( 'the_core_image' ) ) {
	...
	function the_core_image( $attachment = null, $args = null ) {
		...
		if ( $isbg ) {
			...
			return ( $return ) ? array( 'img' => $img, 'ratio' => $ratio_class, 'original_image_url' => $file_url, 'caption' => trim( strip_tags( $attachment->post_excerpt ) ) ) : $img;
		}
	}
}
		...
		if ( $links ) : ?>
			<nav class="navigation paging-navigation" role="navigation">
				<div class="pagination loop-pagination">
					...
					if ( empty( $prev ) ) {
						echo '<a href="javascript:void(0)" class="prev page-numbers disabled"><i class="fa fa-angle-left"></i><strong>' . esc_html__( 'Newer', 'the-core' ) . '</strong></a>';
					}
					echo $links;
					if ( empty( $next ) ) {
						echo '<a href="javascript:void(0)" class="next page-numbers disabled"><strong>' . esc_html__( 'Older', 'the-core' ) . '</strong><i class="fa fa-angle-right"></i></a>';
					}
					?>
				</div><!-- .pagination -->
			</nav><!-- .navigation -->
...
if ( ! function_exists( 'the_core_post_meta' ) ) :
	 ...
	 */
	function the_core_post_meta( $post_id, $post_type = 'post' ) {
...
if ( ! function_exists( 'the_core_post_meta_blog_2' ) ) :
	 ...
	 * @param string $post_type
	 */
	function the_core_post_meta_blog_2( $post_id, $post_type = 'post' ) {
		$the_core_permalink = get_permalink($post_id);
		$posts_general_settings = defined( 'FW' ) ? fw_get_db_settings_option( 'posts_settings', '' ) : array();
		$post_date       = isset( $posts_general_settings['post_date'] ) ? $posts_general_settings['post_date'] : '';
		$post_author     = isset( $posts_general_settings['post_author'] ) ? $posts_general_settings['post_author'] : '';
...
if( ! function_exists( 'the_core_listing_post_options' ) ) :
	...
	function the_core_listing_post_options($post_id) {
		...
		$image       = the_core_image( get_post_thumbnail_id(), $args );
		$ratio_class = (!empty($image_ratio) ) ? $image_ratio.' fw-ratio-container' : $image['ratio'];
...
if ( ! function_exists( 'the_core_get_blog_button' ) ) :
	 ...
	 * @param array $atts
	 */
	function the_core_get_blog_button( $atts = array('permalink' => '') ) {
		...
		if( isset($posts_settings['button_options']) ) {
		...
		if ( isset($the_core_settings_option['posts_settings']['button_options'] ) ) {
			if ( isset( $the_core_settings_option['posts_settings']['button_options']['label_advanced_styling'] ) ) {
				...
				if( !empty( $label_advanced_styling['styles'] ) ) {
					$final_styles .= '.postlist .fw-btn-post-read-more-blog span {'.$label_advanced_styling['styles'].'}';
				...
				if( !empty($hover_text_color['color']) ) $final_styles .= '.postlist .fw-btn-post-read-more-blog:hover span' . '{ color: '.$hover_text_color['color'].' !important }';
			}
			...
			if( isset($the_core_settings_option['posts_settings']['button_options']['style']['selected']) ){
				if($the_core_settings_option['posts_settings']['button_options']['style']['selected'] == 'fw-btn-3'){
					if( isset($the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-3']['border_size']) && !empty($the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-3']['border_size']) ){
						$final_styles .= '.postlist .fw-btn-post-read-more-blog{ border-top-width: '.(int)$the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-3']['border_size'].'px; border-bottom-width: '.(int)$the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-3']['border_size'].'px; }';
					}
					// btn color
					if ( isset( $the_core_settings_option['posts_settings']['button_options']['normal_color'] ) ) {
						...
						if( !empty($normal_color['color']) ) $final_styles .= '.postlist .fw-btn-post-read-more-blog{ border-bottom-color: '.$normal_color['color'].'; border-top-color: '.$normal_color['color'].' }';
					}
					// hover color
					if ( isset( $the_core_settings_option['posts_settings']['button_options']['hover_color'] ) ) {
						...
						if( !empty($hover_color['color']) ) $final_styles .= '.postlist .fw-btn-post-read-more-blog:hover, .postlist .fw-btn-post-read-more-blog:focus { background-color: '.$hover_color['color'].'; border-bottom-color: '.$hover_color['color'].'; border-top-color: '.$hover_color['color'].' }';
					}
				}
				elseif($the_core_settings_option['posts_settings']['button_options']['style']['selected'] == 'fw-btn-2'){
					if( isset($the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-2']['border_size']) && !empty($the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-2']['border_size']) ){
						$final_styles .= '.postlist .fw-btn-post-read-more-blog{ border-width: '.(int)$the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-2']['border_size'].'px; }';
					}
					if( isset($the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-2']['border_radius']) && !empty($the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-2']['border_radius']) ){
						$final_styles .= '.postlist .fw-btn-post-read-more-blog{ border-radius: '.(int)$the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-2']['border_radius'].'px; }';
					}

					// btn color
					if ( isset( $the_core_settings_option['posts_settings']['button_options']['normal_color'] ) ) {
						$normal_color = the_core_get_color_palette_color_and_class( $the_core_settings_option['posts_settings']['button_options']['normal_color'], array('return_color' => true ) );
						if( !empty($normal_color['color']) ) $final_styles .= '.postlist .fw-btn-post-read-more-blog{ border-color: '.$normal_color['color'].' }';
					}
					// hover color
					if ( isset( $the_core_settings_option['posts_settings']['button_options']['hover_color'] ) ) {
						$hover_color = the_core_get_color_palette_color_and_class( $the_core_settings_option['posts_settings']['button_options']['hover_color'], array('return_color' => true ) );
						if( !empty($hover_color['color']) ) $final_styles .= '.postlist .fw-btn-post-read-more-blog:hover { background-color: '.$hover_color['color'].'; border-color: '.$hover_color['color'].' }';
					}
				}
                elseif($the_core_settings_option['posts_settings']['button_options']['style']['selected'] == 'fw-btn-1'){
					if( isset($the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-1']['border_radius']) && !empty($the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-1']['border_radius']) ){
						$final_styles .= '.postlist .fw-btn-post-read-more-blog{ border-radius: '.(int)$the_core_settings_option['posts_settings']['button_options']['style']['fw-btn-1']['border_radius'].'px; }';
					}

					// btn color
					if ( isset( $the_core_settings_option['posts_settings']['button_options']['normal_color'] ) ) {
						$normal_color = the_core_get_color_palette_color_and_class( $the_core_settings_option['posts_settings']['button_options']['normal_color'], array('return_color' => true ) );
						if( !empty($normal_color['color']) ) $final_styles .= '.postlist .fw-btn-post-read-more-blog{ background-color: '.$normal_color['color'].' }';
					}
					// hover color
					if ( isset( $the_core_settings_option['posts_settings']['button_options']['hover_color'] ) ) {
						$hover_color = the_core_get_color_palette_color_and_class( $the_core_settings_option['posts_settings']['button_options']['hover_color'], array('return_color' => true ) );
						if( !empty($hover_color['color']) ) $final_styles .= '.postlist .fw-btn-post-read-more-blog:hover { background-color: '.$hover_color['color'].' }';
					}
				}
			}
		}
...
if ( ! function_exists( 'the_core_get_blog_comments_number' ) ):
	 ...
	 * @param array $atts
	 */
	function the_core_get_blog_comments_number( $atts = array('permalink' => '#') ){
			...
			<div class="fw-container">
				<?php if( is_rtl() ) : ?>
					...
					<?php if ( $atts['top_bar_text'] != '' ) : ?>
						<span class="fw-text-top-bar"><?php echo $atts['top_bar_text']; ?></span>
					<?php endif; ?>
				<?php else: ?>
					<?php if ( $atts['top_bar_text'] != '' ) : ?>
						<span class="fw-text-top-bar"><?php echo $atts['top_bar_text']; ?></span>
		...
		if ( function_exists( 'fw_get_db_settings_option' ) ) {
			...
			if( isset($the_core_settings_option['scroll_to_top_styling']) ) {
				...
				if ( $the_core_settings_option['scroll_to_top_styling']['icon-type']['icon-box-img'] == 'icon-class' ) {
					...
					$icon = '<img src="' . $the_core_settings_option['scroll_to_top_styling']['icon-type']['upload-icon']['upload-custom-img']['url'] . '" />';
				}
...
if( !function_exists('the_core_blog_grid_separator_number') ) :
    ...
    function the_core_blog_grid_separator_number($the_core_sidebar_position){
        if($the_core_sidebar_position == 'full') {
            return 3;
        }
        else {
            return 2;
