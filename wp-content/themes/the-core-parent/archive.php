						...
						<?php if ( have_posts() ) :
							...
							while ( have_posts() ) : the_post();
								...
								*/
								...
								if ( $the_core_general_posts_options['blog_view'] == 'grid' && $the_core_count % $separator_items == 0 && $the_core_general_posts_options['posts_per_page'] != $the_core_count ) {
									echo '<div class="fw-grid-separator"></div>';
								}
							endwhile;
						else :
