...
if( isset($atts['frame']['selected']) && $atts['frame']['selected'] == 'fw-block-image-frame' ){
	...
	if ( $atts['frame']['fw-block-image-frame']['border_color']['id'] == 'fw-custom' ) {
		if ( ! empty( $atts['frame']['fw-block-image-frame']['border_color']['color'] ) ) {
			$frame_style .= ' border-color: ' . $atts['frame']['fw-block-image-frame']['border_color']['color'] . ';';
		}
	} else {
		$frame_class .= ' fw_theme_border_only_' . $atts['frame']['fw-block-image-frame']['border_color']['id'];
	}
}

if( !empty($atts['image_size']) ){
	$frame_style .= ' width: '.(int)$atts['image_size'].'px; height: '.(int)$atts['image_size'].'px';
}
...
<div class="fw-testimonials <?php echo esc_attr( $atts['style'] ); ?> tf-sh-<?php echo esc_attr( $atts['unique_id'] ); ?> <?php echo esc_attr( $atts['class'] ); ?>" <?php echo $data_animation; ?>>
	...
	<div class="fw-testimonials-list" id="<?php echo esc_attr($id); ?>" data-show-in-slider="<?php echo esc_attr($atts['show_in_slider']['selected_value']); ?>" data-timeoutDuration="<?php echo esc_attr($atts['show_in_slider']['yes']['interval']); ?>" data-animation="<?php echo esc_attr($atts['show_in_slider']['yes']['effect']); ?>" data-play="<?php echo esc_attr($play); ?>">
                    ...
                    <div class="fw-testimonials-meta">
                        <?php if( !empty($testimonial['author_avatar']) ) :
                            ...
                            <div class="fw-testimonials-avatar">
                                <img src="<?php echo esc_url( $testimonial['author_avatar'] ); ?>" alt="<?php echo the_core_translate( esc_attr( $testimonial['author_name'] ) ); ?>" class="<?php echo esc_attr($frame_class); ?>" style="<?php echo $frame_style; ?>" />
                            </div>
                        <?php endif; ?>
