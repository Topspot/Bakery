...
if ( isset( $data['settings']['extra']['unique_id'] ) ){
	$unique_id = $unique_class = 'tf-sh-'.$data['settings']['extra']['unique_id'];
}
else{
	$unique_id = $unique_class = uniqid( 'tf-sh-' );
}
...
<?php if ( isset( $data['slides'] ) ) : ?>
	<div class="fw-easy-carousel <?php echo esc_attr($unique_class); ?>">
		...
		<a id="<?php echo esc_attr($unique_class); ?>-prev" class="prev" href="#"><i class="fw-easy-carousel-icon-left"></i></a>
		<a id="<?php echo esc_attr($unique_class); ?>-next" class="next" href="#"><i class="fw-easy-carousel-icon-right"></i></a>
	</div>
<?php endif; ?>