...
$options = array(
	'buddypress' => array(
		'title'   => __( 'BuddyPress', 'the-core' ),
		'type'    => 'tab',
		'options' => array(
			'header-buddypress-box' => array(
				'title'   => __( 'Forums & Topics Header', 'the-core' ),
				'type'    => 'box',
				'options' => array(
					'general_buddypress_header' => array(
						'type'          => 'multi',
						'label'         => false,
						'attr'          => array(
						...
						'inner-options' => array(
							...
							'posts_header_image'           => array(
								...
								'help'  => __( "This default header image will be used for all your buddypress.", "the-core" ),
								'type'  => 'upload'
							),
							...
							'custom_title_group'            => array(
								...
								'options' => array(
									'header_title_typography' => array(
										'attr'          => array(
											'data-advanced-for' => 'buddypress_header_title_advanced_styling',
									...
									'custom_title_text'            => array(
										'attr'  => array( 'class' => 'buddypress_header_title_advanced_styling' ),
										'label' => __( 'Title', 'the-core' ),
									...
									'header_subtitle_typography' => array(
										'attr'          => array(
											'data-advanced-for' => 'buddypress_header_subtitle_advanced_styling',
											'class'             => 'fw-advanced-button'
										),
										'type'          => 'popup',
										'label'         => __( 'Custom Style', 'the-core' ),
									...
									'custom_subtitle_text'         => array(
										'attr'  => array( 'class' => 'buddypress_header_subtitle_advanced_styling' ),
										'label' => __( 'Description', 'the-core' ),
